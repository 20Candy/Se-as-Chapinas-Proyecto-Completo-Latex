...
\usepackage{fontenc}
\usepackage{tabularx}
\usepackage[table,xcdraw]{xcolor} % Add this line to enable row coloring
\usepackage{enumitem}
\usepackage{pdfpages}
...
\titleformat{\paragraph}[block]{\normalfont{\normalsize}}{\theparagraph.}{1em}{}[\titleline*{\titlerule}]%
\titlespacing*{\paragraph}{0pt}{\baselineskip}{0.75\baselineskip}
...
\usepackage{listings}
\lstset{
    basicstyle=\ttfamily\small, % Estilo básico del texto (monoespaciado, tamaño pequeño)
    frame=single,               % Añade un borde alrededor del código
    breaklines=true,            % Permite la división de líneas largas
    backgroundcolor=\color{gray!10}, % Fondo gris claro
    keywordstyle=\color{blue},  % Color para las palabras clave
    morekeywords={messages, role, system, content}, % Define palabras clave adicionales
    numbers=left,               % Añade numeración de líneas a la izquierda
...
\counterwithout{figure}{chapter} % Esto evita que las figuras se reinicien
\counterwithout{table}{chapter}  % Esto evita que las tablas se reinicien
...
%     \pdfbookmark{Carátula}{toc}
	...
	\begin{center}
		...
		\vfill
		\Large Trabajo de graduación en modalidad de Megaproyecto Tecnológico presentado por \\
        \vspace{0.1in}
        \Large \nombreestudiante \\
        \vspace{0.1in}
