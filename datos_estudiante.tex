...
% --------------------------------------------------------------------------------
% Nombre completo
\def \nombreestudiante {Stefano Aragoni Maldonado, Carol Andreé Arévalo Estrada, Jose Miguel Gonzalez y Gonzalez, Luis Diego Santos Cuellar, Roberto Vallecillos Chinchilla}
% Carné
\def \uvgcarne {}
% Facultad
...
\def \anoentrega {2024}
% Asesor
\def \nombreasesor {Ing. Douglas Leonel Barrios Gonzalez}

% Datos del tribunal examinador:
% --------------------------------------------------------------------------------
% Nombre del primer examinador
\def \nombreprimerex {Ing. Eddy Omar Castro}
% Nombre del segundo examinador
\def \nombresegundoex {Ing. Dennis Moritz Aldana Moscoso}
% Fecha de aprobación
\def \fechaaprobacion {29 de noviembre 2024}
